    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-primary" id="add-gudang" title="Add" href="{{ route('transfer-barang.create') }}">
