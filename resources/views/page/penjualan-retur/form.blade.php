...
@push('script')
    ...
    <script src="{{ asset('assets/js/page/penjualan-retur.js') . '?' . date('YmdHis') }}"></script>
@endpush
                ...
                <form id="form" enctype="multipart/form-data">
                    ...
                    <div class="card-title">
                        <div class="col-12 item-title">
                            <h6>
                                {{ $penjualan_retur->id ? 'Edit' : 'Tambah' }}
                                Penjualan Retur</h6>
                    ...
                    <a class="btn btn-link color-softgray-5" title="Back" href="{{ route('penjualan-retur.index') }}">
                    ...
                    <div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="no-nota-retur" type="text" name="no_nota_retur"
                                    value="{{ Helper::set_value('no_nota_retur', @$penjualan_retur->no_nota_retur) }} " />
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control flatpickr tanggal-nota-retur flatpickr" type="text"
                                    name="tgl_nota_retur"
                                    value="{{ Helper::set_value('tgl_nota_retur', Helper::format_tanggal(@$penjualan_retur->tgl_nota_retur, 'dd-mm-yyyy')) }}" />
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="text" name="no_invoice" id="no-invoice" readonly="readonly"
                                        ...
                                        value="{{ Helper::set_value('no_invoice', @$penjualan_retur->no_invoice) }}" />
                                    ...
                                    <input type="hidden" name="id_penjualan"
                                        value="{{ Helper::set_value('id_penjualan', @$penjualan_retur->id_penjualan) }}"
                                        id="id-penjualan" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label class="col-sm-2 col-form-label form-text-12 text-black text-right fw-bold">Nama
                                Pembeli</label>
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="nama_customer" readonly="readonly"
                                    id="nama-customer"
                                    value="{{ Helper::set_value('nama_customer', @$penjualan_retur['nama_customer'] ) }}" />
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label class="col-sm-2 col-form-label form-text-12 text-black text-right fw-bold">Gudang</label>
                            <div class="col-sm-6">
                                {!! Helper::options(['name' => 'gudang_id', 'id' => 'id-gudang', 'disabled' => 'disabled'], $gudang, Helper::set_value('id_gudang', @$penjualan_retur['id_gudang'])) !!}
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <div class="col">
                                ...
                                <div class="table-responsive">
                                    <table style="width:auto{{ $display }}" id="list-produk"
                                                ...
                                                <tr class="barang">
                                                    ...
                                                    <td><span class="nama-barang">{{ @$val['nama_barang'] }}</span>
                                                        <input type="hidden" name="id_penjualan_detail[]"
                                                            class="id-penjualan-detail"
                                                            value="{{ @$val['id_penjualan_detail'] }}" />
                                                    </td>
                                                    <td>{{ @$val['satuan'] }}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control text-end qty-jual"
                                                    ...
                                                    <td>
                                                        <input type="text" size="4"
                                                            class="form-control text-end harga-total-jual"
                                        ...
                                        @php
                                            ...
                                            $penyesuaian_nilai = 0;
                                            if (@$penjualan_retur['penyesuaian']) {
                                                $penyesuaian_operator = $penjualan_retur['penyesuaian'] > 0 ? '+' : '-';
                                                $penyesuaian_nilai = Helper::format_number((int) $penjualan_retur['penyesuaian']);
                                            }
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <input name="sub_total_retur" class="form-control text-end"
                                                        ...
                                                        value="{{ Helper::format_number(Helper::set_value('sub_total_retur', @$penjualan_retur['sub_total_retur'])) }}"
                                                        readonly />
                                                </th>
                                                <th></th>
                                            </tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        {!! Helper::options(
                                                            ...
                                                            ['%' => '%', 'rp' => 'Rp'],
                                                            Helper::set_value('diskon_total_jenis', @$penjualan_retur['diskon_jenis']),
                                                        ) !!}
                                                        <input name="diskon_total_nilai" id="diskon-total"
                                                            class="form-control text-end"
                                                            value="{{ Helper::set_value('diskon_total_nilai', @$penjualan_retur['diskon_nilai']) }}"
                                                            type="text" />
                                                    </div>
                                                </td>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <input name="neto" class="form-control text-end" id="total"
                                                        type="text"
                                                        value="{{ Helper::format_number(Helper::set_value('neto', @$penjualan_retur['neto_retur'])) }}"
                                                        readonly />
                                                </th>
                                                <th></th>
                                            </tr>
                    ...
                    <div class="card-footer mb-10">
                        <div class="col-sm-5">
                            <button type="button" onclick="submitForm(`{{ route('penjualan-retur.store') }}`)"
                                class="btn btn-primary color-blue" id="submit">Submit</button>
                            <input type="hidden" name="id" value="{{ $penjualan_retur->id }}" />
                        </div>
                    </div>
                </form>
            </div>
