...
@push('script')
    ...
    <script src="{{ asset('assets/js/page/pembelian-retur.js') }}"></script>
@endpush
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-primary" id="add-pembelian" title="Add" href="{{ route('pembelian-retur.create') }}">
